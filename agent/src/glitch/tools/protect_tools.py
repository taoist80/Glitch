"""UniFi Protect tools - all 48 tools across 14 groups.

Tools are registered in the 'protect' group in registry.py.
All tools follow the strands @tool decorator pattern.
"""
...
# ============================================================
# All 48 tools as a list for registry registration
# ============================================================

ALL_PROTECT_TOOLS = [
    # Group 1: Core Protect Access
    protect_get_cameras,
    protect_get_events,
