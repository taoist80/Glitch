"""Compound tools for Sentinel — reduce LLM round-trips for common workflows.
...
async def security_correlation_scan(
    ...
    # --- Network clients ---
    try:
        from sentinel.tools.unifi_network_tools import unifi_list_clients
    ...
    # --- Suspicious DNS ---
    try:
        from sentinel.tools.dns_intelligence_tools import dns_detect_suspicious_domains
...
async def analyze_and_alert(
    ...
    Saves 3+ LLM round-trips for the most common Sentinel surveillance workflow.
