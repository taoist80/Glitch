...
async def detect_anomalous_behavior(
    ...
    if behavior:
        from sentinel.protect.recognition import compute_behavior_suspicion_score
...
async def extract_and_store_face_features(
    ...
    """
    from sentinel.protect.recognition import format_face_prompt, extract_face_features, generate_text_signature
    from sentinel.protect import db as protect_db
